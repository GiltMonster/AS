    ...
    <body>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <a href="Controle?flag=ExcluirDepartamento&idDep=<%= dep.getIdDepartamento()%>" class="btn btn-danger">
                ...
                <td>
                    <a href="AlterarDepartamento.jsp?&idDep=<%= dep.getIdDepartamento()%>&nomeDep=<%= dep.getNomeDepartamento()%>&foneDep=<%= dep.getFoneDepartamento()%>" class="btn btn-primary">
